...
export const ZIMBRA_PASSWORD_MIN_UPPERCASE_CHARS_ATTR_NAME =
  "zimbraPasswordMinUpperCaseChars";
export const ZIMBRA_PASSWORD_MIN_LOWERCASE_CHARS_ATTR_NAME =
  "zimbraPasswordMinLowerCaseChars";
export const ZIMBRA_PASSWORD_MIN_PUNCTUATION_CHARS_ATTR_NAME =
  "zimbraPasswordMinPunctuationChars";
export const ZIMBRA_PASSWORD_MIN_NUMERIC_CHARS_ATTR_NAME =
...
export const ZIMBRA_PASSWORD_ENFORCE_HISTORY_ATTR_NAME =
